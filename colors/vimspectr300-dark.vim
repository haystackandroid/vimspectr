...
if exists('g:vimspectr300_dark_MuteAccents')
if g:vimspectr300_dark_MuteAccents == 'on'
let s:g8 = '9e7276'
let s:g9 = '9c7760'
let s:gA = '8a7c55'
let s:gB = '5b8a55'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#362436'
  let g:terminal_color_11 = '#735673'
  let g:terminal_color_12 = '#917f91'
  let g:terminal_color_13 = '#e6d2e6'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr300-dark | endif'
augroup END
let colors_name = 'vimspectr300-dark'
