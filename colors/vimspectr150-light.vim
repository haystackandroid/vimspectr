...
if exists('g:vimspectr150_light_MuteAccents')
if g:vimspectr150_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#d2e6dc'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr150-light | endif'
augroup END
let colors_name = 'vimspectr150-light'
