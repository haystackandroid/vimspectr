" vimspectr330curve-light, a vim theme by nightsense
...
if exists('g:vimspectr330curve_light_MuteAccents')
if g:vimspectr330curve_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#735664'
  let g:terminal_color_8 =  '#917f88'
  let g:terminal_color_9 =  '#eb6f28'
  let g:terminal_color_10 = '#ebd7e1'
  let g:terminal_color_11 = '#968a90'
  let g:terminal_color_12 = '#7a616e'
  let g:terminal_color_13 = '#2e1f26'
  let g:terminal_color_14 = '#d46a84'
  let g:terminal_color_15 = '#1c1016'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr330curve-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr330curve-light'
  endif
endif
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr330curve-light | endif'
augroup END
let colors_name = 'vimspectr330curve-light'
...
if exists('g:vimspectr330curve_light_StatusLine')
if g:vimspectr330curve_light_StatusLine == 'red'
cal <sid>h('StatusLine'       , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'orange'
cal <sid>h('StatusLine'       , s:g0 , s:g9 , s:t0 , s:t9 , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'yellow'
cal <sid>h('StatusLine'       , s:g0 , s:gA , s:t0 , s:tA , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'green'
cal <sid>h('StatusLine'       , s:g0 , s:gB , s:t0 , s:tB , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'teal'
cal <sid>h('StatusLine'       , s:g0 , s:gC , s:t0 , s:tC , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'blue'
cal <sid>h('StatusLine'       , s:g0 , s:gD , s:t0 , s:tD , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'purple'
cal <sid>h('StatusLine'       , s:g0 , s:gE , s:t0 , s:tE , 'none'      , ''  )
elseif g:vimspectr330curve_light_StatusLine == 'pink'
cal <sid>h('StatusLine'       , s:g0 , s:gF , s:t0 , s:tF , 'none'      , ''  )
endif
endif

" disable highlighted CursorLineNr
if exists('g:vimspectr330curve_light_CursorLineNr')
if g:vimspectr330curve_light_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:vimspectr330curve_light_LineNr')
if g:vimspectr330curve_light_LineNr == 'off'
...
" mute LineNr
if exists('g:vimspectr330curve_light_MuteLineNr')
if g:vimspectr330curve_light_MuteLineNr == 'on'
cal <sid>h('LineNr'           , s:g3 , s:g1 , s:t3 , s:t1 , 'none'      , ''  )
endif
endif

" mute StatusLine
if exists('g:vimspectr330curve_light_MuteStatusLine')
if g:vimspectr330curve_light_MuteStatusLine == 'on'
cal <sid>h('StatusLine'       , s:g0 , s:g3 , s:t0 , s:t3 , 'none'      , ''  )
endif
endif

" enable italicized comments
if exists('g:vimspectr330curve_light_ItalicComment')
if g:vimspectr330curve_light_ItalicComment == 'on'
