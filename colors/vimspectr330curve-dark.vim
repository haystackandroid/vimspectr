" vimspectr330curve-dark, a vim theme by nightsense
...
if exists('g:vimspectr330curve_dark_MuteAccents')
if g:vimspectr330curve_dark_MuteAccents == 'on'
let s:g8 = '9e7276'
let s:g9 = '9c7760'
let s:gA = '8a7c55'
let s:gB = '5b8a55'
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#968a90'
  let g:terminal_color_8 =  '#7a616e'
  let g:terminal_color_9 =  '#b56f45'
  let g:terminal_color_10 = '#2e1f26'
  let g:terminal_color_11 = '#735664'
  let g:terminal_color_12 = '#917f88'
  let g:terminal_color_13 = '#ebd7e1'
  let g:terminal_color_14 = '#ab6a7a'
  let g:terminal_color_15 = '#ffeaf4'
endif
...
if filereadable(expand('~/.vimspectr-shell/vimspectr330curve-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.vimspectr-shell/vimspectr330curve-dark'
  endif
endif
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr330curve-dark | endif'
augroup END
let colors_name = 'vimspectr330curve-dark'
...
if exists('g:vimspectr330curve_dark_StatusLine')
if g:vimspectr330curve_dark_StatusLine == 'red'
cal <sid>h('StatusLine'       , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'orange'
cal <sid>h('StatusLine'       , s:g0 , s:g9 , s:t0 , s:t9 , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'yellow'
cal <sid>h('StatusLine'       , s:g0 , s:gA , s:t0 , s:tA , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'green'
cal <sid>h('StatusLine'       , s:g0 , s:gB , s:t0 , s:tB , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'teal'
cal <sid>h('StatusLine'       , s:g0 , s:gC , s:t0 , s:tC , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'blue'
cal <sid>h('StatusLine'       , s:g0 , s:gD , s:t0 , s:tD , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'purple'
cal <sid>h('StatusLine'       , s:g0 , s:gE , s:t0 , s:tE , 'none'      , ''  )
elseif g:vimspectr330curve_dark_StatusLine == 'pink'
cal <sid>h('StatusLine'       , s:g0 , s:gF , s:t0 , s:tF , 'none'      , ''  )
endif
endif

" disable highlighted CursorLineNr
if exists('g:vimspectr330curve_dark_CursorLineNr')
if g:vimspectr330curve_dark_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:vimspectr330curve_dark_LineNr')
if g:vimspectr330curve_dark_LineNr == 'off'
...
" mute LineNr
if exists('g:vimspectr330curve_dark_MuteLineNr')
if g:vimspectr330curve_dark_MuteLineNr == 'on'
cal <sid>h('LineNr'           , s:g3 , s:g1 , s:t3 , s:t1 , 'none'      , ''  )
endif
endif

" mute StatusLine
if exists('g:vimspectr330curve_dark_MuteStatusLine')
if g:vimspectr330curve_dark_MuteStatusLine == 'on'
cal <sid>h('StatusLine'       , s:g0 , s:g3 , s:t0 , s:t3 , 'none'      , ''  )
endif
endif

" enable italicized comments
if exists('g:vimspectr330curve_dark_ItalicComment')
if g:vimspectr330curve_dark_ItalicComment == 'on'
