...
if exists('g:vimspectr240_dark_MuteAccents')
if g:vimspectr240_dark_MuteAccents == 'on'
let s:g8 = '9e7276'
let s:g9 = '9c7760'
let s:gA = '8a7c55'
let s:gB = '5b8a55'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#27273b'
  let g:terminal_color_11 = '#5a5a78'
  let g:terminal_color_12 = '#7f7f91'
  let g:terminal_color_13 = '#d0d0e3'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr240-dark | endif'
augroup END
let colors_name = 'vimspectr240-dark'
