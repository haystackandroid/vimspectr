...
if filereadable(expand('~/.nightshell/vimspectr210wcurve-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/vimspectr210wcurve-light'
  endif
endif
