...
if has('nvim')
  ...
  let g:terminal_color_11 = '#a3a3a3'
  let g:terminal_color_12 = '#7a7a7a'
  let g:terminal_color_13 = '#383838'
...
if filereadable(expand('~/.nightshell/vimspectrgrey-light'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/vimspectrgrey-light'
  endif
endif
