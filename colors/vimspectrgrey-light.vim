...
if exists('g:vimspectrgrey_light_MuteAccents')
if g:vimspectrgrey_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_11 = '#999999'
  let g:terminal_color_12 = '#707070'
  let g:terminal_color_13 = '#2e2e2e'
  let g:terminal_color_14 = '#d46a84'
  let g:terminal_color_15 = '#212121'
endif
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectrgrey-light | endif'
augroup END
let colors_name = 'vimspectrgrey-light'
