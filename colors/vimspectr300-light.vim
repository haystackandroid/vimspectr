...
if exists('g:vimspectr300_light_MuteAccents')
if g:vimspectr300_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#e6d2e6'
  let g:terminal_color_11 = '#968a96'
  let g:terminal_color_12 = '#7a617a'
  let g:terminal_color_13 = '#362436'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr300-light | endif'
augroup END
let colors_name = 'vimspectr300-light'
