...
if exists('g:vimspectr240_light_MuteAccents')
if g:vimspectr240_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#d0d0e3'
  let g:terminal_color_11 = '#8c8c99'
  let g:terminal_color_12 = '#676782'
  let g:terminal_color_13 = '#27273b'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr240-light | endif'
augroup END
let colors_name = 'vimspectr240-light'
