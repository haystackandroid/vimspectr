...
if exists('g:vimspectr330_light_MuteAccents')
if g:vimspectr330_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#e6d2dc'
  let g:terminal_color_11 = '#968a90'
  let g:terminal_color_12 = '#7a616e'
  let g:terminal_color_13 = '#36242d'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr330-light | endif'
augroup END
let colors_name = 'vimspectr330-light'
