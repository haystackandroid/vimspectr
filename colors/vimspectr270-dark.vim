...
if exists('g:vimspectr270_dark_MuteAccents')
if g:vimspectr270_dark_MuteAccents == 'on'
let s:g8 = '9e7276'
let s:g9 = '9c7760'
let s:gA = '8a7c55'
let s:gB = '5b8a55'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#2f2538'
  let g:terminal_color_11 = '#675875'
  let g:terminal_color_12 = '#887f91'
  let g:terminal_color_13 = '#dcd2e6'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr270-dark | endif'
augroup END
let colors_name = 'vimspectr270-dark'
