...
if exists('g:vimspectr270_light_MuteAccents')
if g:vimspectr270_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#dcd2e6'
  let g:terminal_color_11 = '#938c99'
  let g:terminal_color_12 = '#70637d'
  let g:terminal_color_13 = '#2f2538'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr270-light | endif'
augroup END
let colors_name = 'vimspectr270-light'
