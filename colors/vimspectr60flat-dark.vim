...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#a1a193'
  let g:terminal_color_8 =  '#78786e'
  let g:terminal_color_9 =  '#b56f45'
  let g:terminal_color_10 = '#363631'
...
if filereadable(expand('~/.nightshell/vimspectr60flat-dark'))
  if !has('gui_running')
    execute 'silent !/bin/sh $HOME/.nightshell/vimspectr60flat-dark'
  endif
endif
