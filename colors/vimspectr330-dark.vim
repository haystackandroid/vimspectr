...
if exists('g:vimspectr330_dark_MuteAccents')
if g:vimspectr330_dark_MuteAccents == 'on'
let s:g8 = '9e7276'
let s:g9 = '9c7760'
let s:gA = '8a7c55'
let s:gB = '5b8a55'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#36242d'
  let g:terminal_color_11 = '#735664'
  let g:terminal_color_12 = '#917f88'
  let g:terminal_color_13 = '#e6d2dc'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr330-dark | endif'
augroup END
let colors_name = 'vimspectr330-dark'
