...
if exists('g:vimspectr210_light_MuteAccents')
if g:vimspectr210_light_MuteAccents == 'on'
let s:g8 = 'db7681'
let s:g9 = 'd1814f'
let s:gA = 'ad9142'
let s:gB = '4aa840'
...
if has('nvim')
  ...
  let g:terminal_color_10 = '#d2dce6'
  let g:terminal_color_11 = '#888e94'
  let g:terminal_color_12 = '#5d6975'
  let g:terminal_color_13 = '#222b33'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr210-light | endif'
augroup END
let colors_name = 'vimspectr210-light'
