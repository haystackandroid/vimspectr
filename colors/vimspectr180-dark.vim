...
if exists('g:vimspectr180_dark_MuteAccents')
if g:vimspectr180_dark_MuteAccents == 'on'
let s:g8 = '9e7276'
let s:g9 = '9c7760'
let s:gA = '8a7c55'
let s:gB = '5b8a55'
...
if has('nvim')
  ...
  let g:terminal_color_13 = '#d2e6e6'
...
augroup VimspectrThemeSet
   ...
   autocmd CursorMoved * execute 'if !exists("colors_name") |
         \ colorscheme vimspectr180-dark | endif'
augroup END
let colors_name = 'vimspectr180-dark'
